...
class BitcoinMessage(ImmutableSerializable):
    ...
    def stream_deserialize(cls, f):
        magic = bitcoinlib.core.serialize.BytesSerializer.stream_deserialize(f)
        message = bitcoinlib.core.serialize.BytesSerializer.stream_deserialize(f)
        return cls(message, magic)

    def stream_serialize(self, f):
        bitcoinlib.core.serialize.BytesSerializer.stream_serialize(self.magic, f)
        bitcoinlib.core.serialize.BytesSerializer.stream_serialize(self.message, f)
