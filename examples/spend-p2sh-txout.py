...
from bitcoinlib.core import b2x, lx, COIN, COutPoint, CMutableTxOut, CMutableTxIn, CMutableTransaction, Hash160
from bitcoinlib.core.script import CScript, OP_DUP, OP_HASH160, OP_EQUALVERIFY, OP_CHECKSIG, SignatureHash, SIGHASH_ALL
from bitcoinlib.core.scripteval import VerifyScript, SCRIPT_VERIFY_P2SH
...
# look at the CScript.to_p2sh_scriptPubKey() function in bitcoinlib.core.script to
